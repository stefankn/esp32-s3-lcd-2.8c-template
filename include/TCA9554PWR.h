/*
TCA9554PWR is the driver for the TCA9554PWR chip, which is a GPIO expander.
A GPIO expander adds extra input/output pins to a microcontroller over I2C when the microcontroller doesn't have enough physical pins for everything it needs to control.
*/
